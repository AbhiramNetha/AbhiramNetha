...
[![Portfolio](https://img.shields.io/badge/🌐%20Portfolio-FFD700?style=for-the-badge&logo=vercel&logoColor=black)](https://abhiramsportfolio17.vercel.app/)
...
```java
public class AbhiramNetha {

    String name        = "Pamu Abhiram";
    String location    = "Hyderabad, India 🇮🇳";
    String degree      = "B.Tech CSE @ ACE Engineering College (2026)";
    double cgpa        = 8.44;

    String[] currentlyLearning = { "Spring Boot", "Microservices", "System Design" };
    String[] interests         = { "Backend Development", "Full-Stack", "DSA" };
    String   funFact           = "I debug with coffee ☕ and fix bugs with more coffee";

    String getGoal() {
        return "Building scalable backend systems & real-world applications 🚀";
    }
}
```
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>🥗 FitFuel AI</h3>
      <p><strong>Smart Nutrition & Fitness Tracker</strong></p>
      <p>Full-stack fitness platform with AI-powered goal-based calorie calculation, real-time meal tracking, 90-day analytics & interactive data visualizations.</p>
      <p>
      ...
      <a href="https://abhiramnethafitfuelai.vercel.app/">
...
|---|---|---|---|
| ACE Engineering College, Hyderabad | B.Tech – Computer Science & Engineering | 2022 – 2026 | **8.44 / 10** |
...
[![Portfolio](https://img.shields.io/badge/🌐%20Visit%20My%20Portfolio-FFD700?style=for-the-badge&logo=vercel&logoColor=black)](https://abhiramsportfolio17.vercel.app/)
